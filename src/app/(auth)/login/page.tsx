            ...
            <Input
              ...
              className={
                errors.email
                  ...
                  : "bg-background/40 dark:bg-slate-950/40 border-border/80 dark:border-white/5 focus-visible:ring-primary/20 focus-visible:border-primary/50 transition-all"
              }
              {...register("email")}
            />
            {errors.email && (
              ...
              <Input
                ...
                className={
                  errors.password
                    ...
                    : "bg-background/40 dark:bg-slate-950/40 border-border/80 dark:border-white/5 focus-visible:ring-primary/20 focus-visible:border-primary/50 transition-all pr-10"
                }
                {...register("password")}
              />
              <button
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background px-4 py-12 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        <Suspense
          fallback={
            <div className="flex h-64 items-center justify-center rounded-xl border border-border/80 bg-card shadow-xl">
