      ...
      <Card className="border border-border/80 shadow-sm overflow-hidden">
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-3.5 rounded-xl border border-border/60 bg-muted/5 flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                {employee.phone ? (
                  <a href={`tel:${employee.phone}`} className="text-sm font-semibold mt-1 block hover:underline text-foreground truncate">
                    {employee.phone}
                  </a>
                ) : (
            ...
            <div className="p-3.5 rounded-xl border border-border/60 bg-muted/5 flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <a href={`mailto:${employee.email}`} className="text-sm font-semibold mt-1 block hover:underline text-foreground truncate">
                  {employee.email}
                </a>
              </div>
            </div>
      ...
      <Card className="border border-border/80 shadow-sm overflow-hidden">
        ...
        <CardContent className="p-6">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-xl border border-border/80 bg-gradient-to-br from-background to-muted/20 p-5 space-y-2 shadow-2xs">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-muted-foreground">
                  <div className="p-2 rounded-lg bg-blue-500/10 text-blue-600 dark:text-blue-400">
                    <Building2 size={18} />
                  </div>
                  <p className="text-xs uppercase font-bold tracking-wider text-muted-foreground">Assigned Branches</p>
                </div>
                <Badge variant="outline" className="font-semibold text-xs">
                  {branchCount} {branchCount === 1 ? "Location" : "Locations"}
                </Badge>
              </div>
              <p className="text-3xl font-extrabold text-foreground pt-1">{branchCount}</p>
            ...
            <div className="rounded-xl border border-border/80 bg-gradient-to-br from-background to-muted/20 p-5 space-y-2 shadow-2xs">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <p className="text-xs uppercase font-bold tracking-wider text-muted-foreground">Service Capabilities</p>
                </div>
                <Badge variant="outline" className="font-semibold text-xs">
                  {serviceCount} {serviceCount === 1 ? "Service" : "Services"}
                </Badge>
              </div>
              <p className="text-3xl font-extrabold text-foreground pt-1">{serviceCount}</p>
