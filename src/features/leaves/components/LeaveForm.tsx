...
export default function LeaveForm({
  ...
  const {
    ...
    resolver: zodResolver(
      isEditMode ? updateLeaveSchema : createLeaveSchema,
    ) as unknown as Resolver<CreateLeaveFormValues>,
    defaultValues,
  });
      ...
      <div className="space-y-4">
          ...
          <div>
            ...
            {isLoadingEmployees ? (
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                <Loader2 className="h-3 w-3 animate-spin" /> Loading active
                staff...
              </div>
            ) : (
              <select
        ...
        <div>
          ...
          <Textarea
            ...
            className={`min-h-25 ${errors.reason ? "border-destructive focus-visible:ring-destructive" : ""}`}
            disabled={isSubmitting}
            {...register("reason")}
          />
          {errors.reason && (
