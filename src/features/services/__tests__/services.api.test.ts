...
describe("Services API Layer Anti-Corruption & Alignment", () => {
  ...
  describe("mapServiceDTO Normalization", () => {
    it("correctly normalizes RawServiceDTO into clean frontend Service model", () => {
      ...
      expect(asRecord.taxable).toBeUndefined();
      expect(asRecord.taxRate).toBeUndefined();
    });
  ...
  describe("GET Endpoints", () => {
    it("getServices calls GET /services with branchScope none and normalizes list", async () => {
      const rawDto: RawServiceDTO = {
        _id: "srv_1",
        name: "Shampoo",
        serviceCode: "SH001",
    ...
    it("getService calls GET /services/:id with branchScope none and normalizes single item", async () => {
      const rawDto: RawServiceDTO = {
        _id: "srv_2",
        name: "Pedicure",
        serviceCode: "PED01",
  ...
  describe("POST /services (Create)", () => {
    it("createService sends a flat payload without tax fields and branchScope none", async () => {
  ...
  describe("PUT /services/:id (Update)", () => {
    it("updateService translates flat basePrice into nested pricing with branchScope none", async () => {
      const rawResponse: RawServiceDTO = {
        _id: "srv_upd",
    ...
    it("updateService does NOT send empty pricing when price is not updated", async () => {
      const rawResponse: RawServiceDTO = {
        _id: "srv_upd2",
  ...
  describe("Status Update & Reactivation", () => {
    it("updateServiceStatus(true) sends PUT /services/:id with status active and branchScope none", async () => {
      const rawResponse: RawServiceDTO = {
        _id: "srv_status",
        status: "active",
      };
    ...
    it("updateServiceStatus(false) sends PUT /services/:id with status inactive and branchScope none", async () => {
      const rawResponse: RawServiceDTO = {
        _id: "srv_status",
        status: "inactive",
      };
    ...
    it("reactivateService uses PATCH /services/:id/reactivate with branchScope none", async () => {
      const rawResponse: RawServiceDTO = {
        _id: "srv_reactivate",
        status: "active",
      };
    ...
    it("deleteService calls DELETE /services/:id with branchScope none", async () => {
